		...
		<div className={`${styles.container}`}>
			...
			<main className={`${styles.main} text-black font-mono`}>
				...
				<p className={`${styles.description} mb-10 text-center justify-center`}>
					$HUX is a the first currency that creates NFTs when you share it. Send 1 million $HUX to a Tezos friend, and two cute cats will be born and minted to your wallets as a memory. A total of 42 $HUX memories can be created this way. $HUX contract: KT1MT3rZkTE8cN8eGQaNJ2Wg2D2nPPtdxELv, Minting Contract: KT1Wz92wmPaBmR4eEk9J2iAds2n1NEQTVsFb.<br>A project by Max Haarich / UzupisMUC
				</p>
